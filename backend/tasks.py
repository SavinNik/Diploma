    ...
    def do_import(url):
        ...
        if url:
            ...
            try:
                ...
                shop, _ = Shop.objects.get_or_create(name=data['shop'], user_id=data['user_id'])
                ...
                for item in data['goods']:
                    product, _ = Product.objects.get_or_create(name=item['name'], category_id=item['category_id'])
